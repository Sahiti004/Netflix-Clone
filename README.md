To get the project running, clone the repository and run `npm install` and `npm start` in the Frontend folder and `npm install` followed by `node server.js` in the Backend folder
